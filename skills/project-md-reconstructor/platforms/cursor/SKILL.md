...
description: Cursor adapter for project-md-reconstructor. Use when Cursor needs to scan an existing repository and generate docs/project.md from a fixed project context template.
license: MIT
