...
description: Cursor adapter for project-md-reconstructor. Use when Cursor needs to classify the current repository as frontend, backend, full-stack, or unclear, then generate docs/project.md and only the matching technical document(s).
license: MIT
