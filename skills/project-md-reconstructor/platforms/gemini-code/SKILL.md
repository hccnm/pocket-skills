...
description: Gemini Code adapter for project-md-reconstructor. Use when Gemini Code needs to scan an existing repository and generate docs/project.md from a fixed project context template.
license: MIT
